package net.graeyamber.graeystuff.block;

import net.graeyamber.graeystuff.GraeyStuff;
import net.graeyamber.graeystuff.block.custom.RedstoneGaugeBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, GraeyStuff.MODID);
